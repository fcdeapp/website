...
const QUIZ_ITEMS: QuizItem[] = [
  ...
  },
  {
    id: 4,
    section: "main",
    text: "허균은 「남궁선생전」에서 이 물음을, 도망자가 된 선비 남궁두가 산중에서 장로를 만나 수련에 들었으나 끝내 신선의 문턱에서 좌절하는 일생으로 풀어낸다.",
    keyTerms: ["허균", "남궁선생전", "도망자가 된 선비", "남궁두", "신선의 문턱"],
  },
  {
    id: 5,
    section: "main",
    text: "나는 남궁두를 무너뜨린 것이 재능도 식색(食色) 같은 욕망도 아니라 완성을 향한 조급함이며, 허균이 내세우는 '인(忍)'은 높은 경지를 향한 의지가 '지금 당장 이루려는 마음'으로 변질되는 순간을 누르는 규율이라고 본다.",
    keyTerms: ["재능", "식색(食色)", "완성을 향한 조급함", "인(忍)", "지금 당장 이루려는 마음"],
  },
  {
    id: 6,
    section: "main",
  ...
  },
  {
    ...
    keyTerms: ["그릇", "욕념", "잠과 곡식", "고통", "견뎌 냈다"],
  },
  {
    id: 8,
    section: "main",
    text: '그러나 단(丹)이 맺히려는 결정적 순간 "속히 이루고 싶은 마음이 갑자기 일어"나 화기가 치솟으면서 모든 것이 어그러진다(35%).',
  ...
  },
  {
    ...
    keyTerms: ["식색", "일체의 망상", "진(眞)", "빨리 도달하려는 마음", "그 자체"],
  },
  {
    id: 10,
    section: "main",
    text: '산을 내려온 뒤 남궁두 스스로 "속히 이루려 하다가 결국 뜻을 이루지 못했다"고 진단하니(90%), 인물의 자기 진단과 필자의 논평이 한 지점에서 만난다.',
    keyTerms: ["산을 내려온 뒤", "속히 이루려", "뜻을 이루지 못했다", "자기 진단", "필자의 논평"],
  },
  {
    id: 11,
    section: "main",
  ...
  },
  {
    id: 12,
    section: "main",
    text: "이 논자들은 忍이 '참을성'이자 '잔인함'을 뜻하고 不忍이 맹자의 불인인지심(不忍人之心)을 환기했음을 복원한 뒤, 남궁두가 끝내 욕망을 참지 못하는 불인함, 곧 인간성을 드러낸다고 보아 그 좌절을 신선술의 실패가 아니라 성리학적 진리의 재확인으로 읽는다.",
    keyTerms: ["참을성", "잔인함", "불인인지심", "인간성", "성리학적 진리의 재확인"],
  },
  {
    id: 13,
    section: "main",
    text: "나는 이 지평을 그 층위에서는 타당하다고 인정한다.",
    keyTerms: ["이 지평", "그 층위", "타당", "인정"],
  },
  {
    id: 14,
    section: "main",
    text: "그러나 저자의 의도가 고정되는 층위에서는 이를 받아들이지 않는다.",
    keyTerms: ["저자의 의도", "고정되는 층위", "받아들이지 않는다"],
  },
  {
    id: 15,
    section: "main",
    text: "통상 논자들이 이 작품을 전계(傳系) 한문소설로 다루는 만큼, 나는 전(傳)이 말미의 논찬(論贊)에 필자의 평을 직접 싣는 양식임에 주목한다.",
    keyTerms: ["전계(傳系) 한문소설", "전(傳)", "논찬(論贊)", "필자의 평", "양식"],
  },
  {
    id: 16,
    section: "main",
  ...
  },
  {
    id: 17,
    section: "main",
    text: "불인함을 미덕으로 삼았다면 그 좌절을 차라리 다행으로 그렸을 터이다.",
    keyTerms: ["불인함", "미덕", "좌절", "다행"],
  },
  {
    id: 18,
    section: "main",
    text: "더욱이 그는 결말에서 자신을 실명과 실연대로 못 박아 서술자를 역사적 저자에 포개므로, '허자는 구성된 페르소나일 뿐'이라는 반론도 막힌다.",
    keyTerms: ["결말", "실명과 실연대", "역사적 저자", "구성된 페르소나", "반론"],
  },
  {
    id: 19,
    section: "main",
    text: "실패의 원인은 초월을 원한 것 자체가 아니다.",
    keyTerms: ["실패의 원인", "초월", "자체가 아니다"],
  },
  {
    id: 20,
    section: "main",
    text: "장로 또한 초월을 원했고 11년 수련 끝에 신태(神胎)를 이루었으니(48%), 의지 자체는 결격 사유가 아니다.",
    keyTerms: ["장로", "11년 수련", "신태(神胎)", "의지 자체", "결격 사유"],
  },
  {
    id: 21,
    section: "main",
    text: "허균의 답은 욕망을 긍정하라는 것이 아니라, 가장 높은 것을 향한 의지조차 조급함으로 변질되는 순간 스스로를 무너뜨린다는 것이다.",
    keyTerms: ["허균의 답", "욕망을 긍정", "가장 높은 것을 향한 의지", "조급함", "스스로를 무너뜨린다"],
  },
  {
    id: 22,
    section: "plan",
...
> = {
  all: {
    ...
    hint:
      "전체 글의 흐름을 제목/문제 → 해석 → 근거 → 반론 → 반박 → 초월과 의지의 구분 → 결론 → 수정 계획 순서로 배열하세요.",
  },
  main: {
    answers: [
      "문제 설정",
    ...
    hint:
      "본문의 큰 구조를 문제 설정 → 자기 해석 → 작품 근거 → 대안 독법 → 인정 → 반박 → 초월과 의지의 구분 → 결론 흐름으로 배열하세요.",
  },
  plan: {
    answers: [
      "수정 필요성 제시",
