      ...
      <div className={styles.container}>
        ...
        <section className={styles.section} data-aos="fade-up">
          ...
          <div className={styles.pdfGrid}>
            <figure className={styles.pdfFrame}>
              ...
              <figcaption><a className={styles.downloadLink} href="/downloads/Panel.pdf" download>Download Panel.pdf</a></figcaption>
            </figure>
            <figure className={styles.pdfFrame}>
              <embed src="/downloads/DesignReport.pdf" type="application/pdf" className={styles.pdf} />
              <figcaption><a className={styles.downloadLink} href="/downloads/DesignReport.pdf" download>Download DesignReport.pdf</a></figcaption>
            </figure>
          </div>
        </section>
        ...
        <section className={styles.sectionAlt} data-aos="fade-left">
          ...
          <div className={styles.card}>
            ...
            <p>Participated in Bailey-bridge assembly & routine training.<br />Received a <strong>Division Commander’s Commendation</strong> for a startup idea during service.</p>
          </div>
        </section>
        ...
        <section className={styles.adSection} data-aos="fade-up">
          <div className={styles.adTextBlock}>
            ...
            <p className={styles.adText}>
              Abrody turns everyday conversations into interactive, AI-powered language quizzes—so you learn vocabulary and expressions that truly matter to you.
            </p>
          </div>
          <img
