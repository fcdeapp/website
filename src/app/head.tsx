...
export default function Head() {
    return (
      <>
        ...
        <meta name="twitter:title"       content="Abrody – Language Learning" />
        ...
        <meta name="twitter:image:alt"   content="Abrody – Language Learning" />
      </>
    );
  }
